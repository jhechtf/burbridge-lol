/**
 * Manually copied over. should automate it at some point but meh.
 */
...
export interface ApiChapterChapter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    chapter_title: Schema.Attribute.String;
    contents: Schema.Attribute.Blocks & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOtherOther extends Struct.CollectionTypeSchema {
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    others: Schema.Attribute.Relation<'manyToMany', 'api::other.other'>;
    publishedAt: Schema.Attribute.DateTime;
    stories: Schema.Attribute.Relation<'manyToMany', 'api::story.story'>;
    tag_id: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
