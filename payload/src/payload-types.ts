...
export interface Config {
	...
	collectionsSelect: {
		...
		others: OthersSelect<false> | OthersSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "others_select".
 */
export interface OthersSelect<T extends boolean = true> {
	title?: T;
	contents?: T;
	generateSlug?: T;
	slug?: T;
